 ...
 * 
 */
public class EventDrivenModuleSchedulerImpl extends ModuleSchedulerImpl
		implements EventDrivenModuleScheduler {

	/**
	 * Logging.
	 */
	private static Logger logger = LogManager
			.getLogger(EventDrivenModuleSchedulerImpl.class);
	 ...
	 */
	public EventDrivenModuleSchedulerImpl(
		...
		while (super.continueRunning()) {
			try {
				...
				boolean conditionMatched =
						super.matchTriggeringCondition(eEvent);
