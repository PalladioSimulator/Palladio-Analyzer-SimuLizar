package org.palladiosimulator.simulizar.elasticity.configuration;
...
/**
 * Configuration tabs for SimuLizar, only the first one is customized. The rest is taken from
 * SimuCom launch configuration.
 * 
