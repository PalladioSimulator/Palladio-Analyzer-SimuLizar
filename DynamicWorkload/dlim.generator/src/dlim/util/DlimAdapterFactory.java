...
public class DlimAdapterFactory extends AdapterFactoryImpl {
	...
	protected DlimSwitch<Adapter> modelSwitch =
		new DlimSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTimeDependentWorkFunctionContainer(TimeDependentWorkFunctionContainer object) {
				return createTimeDependentWorkFunctionContainerAdapter();
			}
			@Override
			public Adapter caseWorkLoadSequence(WorkLoadSequence object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link dlim.TimeDependentWorkFunctionContainer <em>Time Dependent Work Function Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTimeDependentWorkFunctionContainerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link dlim.WorkLoadSequence <em>Work Load Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
