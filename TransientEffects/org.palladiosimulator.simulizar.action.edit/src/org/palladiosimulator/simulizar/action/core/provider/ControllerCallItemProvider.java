...
public class ControllerCallItemProvider extends EntityItemProvider {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ControllerCall_component_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ControllerCall_component_feature", "_UI_ControllerCall_type"),
	...
	protected void addCalledSignaturePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ControllerCall_calledSignature_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ControllerCall_calledSignature_feature", "_UI_ControllerCall_type"),
	...
	public String getText(Object object) {
        String label = ((ControllerCall)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_ControllerCall_type") :
