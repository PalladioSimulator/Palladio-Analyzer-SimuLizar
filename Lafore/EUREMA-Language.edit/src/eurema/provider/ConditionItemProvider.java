...
/**
 * This is the item provider adapter for a {@link eurema.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_expr_feature", "_UI_Condition_type"),
				 EuremaPackage.Literals.CONDITION__EXPR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Condition)object).getExpr();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Condition.class)) {
			case EuremaPackage.CONDITION__EXPR:
