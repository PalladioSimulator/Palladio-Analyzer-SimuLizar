...
/**
 * This is the item provider adapter for a {@link eurema.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EuremaPackage.Literals.EVENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EuremaPackage.Literals.EVENT__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPayloadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_payload_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_payload_feature", "_UI_Event_type"),
				 EuremaPackage.Literals.EVENT__PAYLOAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Event.class)) {
			case EuremaPackage.EVENT__NAME:
			case EuremaPackage.EVENT__PAYLOAD:
