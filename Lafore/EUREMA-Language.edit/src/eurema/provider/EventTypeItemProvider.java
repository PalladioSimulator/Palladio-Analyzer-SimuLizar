...
/**
 * This is the item provider adapter for a {@link eurema.EventType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventType_type_feature", "_UI_EventType_type"),
				 EuremaPackage.Literals.EVENT_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EuremaPackage.Literals.EVENT_TYPE__SUB_TYPES);
		}
	...
	public String getText(Object object) {
		String label = ((EventType)object).getType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EuremaPackage.Literals.EVENT_TYPE__SUB_TYPES,
				 EuremaFactory.eINSTANCE.createEventType()));
	}
