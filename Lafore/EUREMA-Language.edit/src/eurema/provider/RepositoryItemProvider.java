...
/**
 * This is the item provider adapter for a {@link eurema.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EuremaPackage.Literals.REPOSITORY__SOFTWARE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Repository.class)) {
			case EuremaPackage.REPOSITORY__SOFTWARE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EuremaPackage.Literals.REPOSITORY__SOFTWARE,
				 EuremaFactory.eINSTANCE.createSoftware()));
	}
