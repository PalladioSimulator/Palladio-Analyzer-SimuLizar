...
import org.palladiosimulator.simulizar.reconfiguration.Strategy;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.simulizar.reconfiguration.impl.StrategyImpl#getSlos <em>Slos</em>}</li>
 *   <li>{@link org.palladiosimulator.simulizar.reconfiguration.impl.StrategyImpl#getTactics <em>Tactics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StrategyImpl extends NamedElementImpl implements Strategy {
	...
	protected EClass eStaticClass() {
		return ReconfigurationPackage.Literals.STRATEGY;
	}
		...
		if (slos != null && ((EObject)slos).eIsProxy()) {
			...
			if (slos != oldSlos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReconfigurationPackage.STRATEGY__SLOS, oldSlos, slos));
			}
		}
		return slos;
	}
	...
	public void setSlos(ServiceLevelObjectiveRepository newSlos) {
		...
		slos = newSlos;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReconfigurationPackage.STRATEGY__SLOS, oldSlos, slos));
	}
	...
	public EList<Tactic> getTactics() {
		if (tactics == null) {
			tactics = new EObjectContainmentEList<Tactic>(Tactic.class, this, ReconfigurationPackage.STRATEGY__TACTICS);
		}
		return tactics;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReconfigurationPackage.STRATEGY__TACTICS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReconfigurationPackage.STRATEGY__SLOS:
