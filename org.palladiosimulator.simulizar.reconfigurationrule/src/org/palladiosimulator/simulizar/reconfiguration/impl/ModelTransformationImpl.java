 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.simulizar.reconfiguration.impl.ModelTransformationImpl#getModelTransformation <em>Model Transformation</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModelTransformationImpl<ExecutableTransformationElement extends Object> extends MinimalEObjectImpl.Container implements ModelTransformation<ExecutableTransformationElement> {
	...
	protected EClass eStaticClass() {
		return ReconfigurationPackage.Literals.MODEL_TRANSFORMATION;
	}
		...
		if (modelTransformation != null && ((EObject)modelTransformation).eIsProxy()) {
			...
			if (modelTransformation != oldModelTransformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReconfigurationPackage.MODEL_TRANSFORMATION__MODEL_TRANSFORMATION, oldModelTransformation, modelTransformation));
			}
		}
	...
	public void setModelTransformation(ExecutableTransformationElement newModelTransformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReconfigurationPackage.MODEL_TRANSFORMATION__MODEL_TRANSFORMATION, oldModelTransformation, modelTransformation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReconfigurationPackage.MODEL_TRANSFORMATION__MODEL_TRANSFORMATION:
