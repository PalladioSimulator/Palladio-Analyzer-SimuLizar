...
public class ReconfigurationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ReconfigurationPackage.MODEL_TRANSFORMATION: {
			...
			case ReconfigurationPackage.RECONFIGURATION: {
				Reconfiguration reconfiguration = (Reconfiguration)theEObject;
				T result = caseReconfiguration(reconfiguration);
				if (result == null) result = caseNamedElement(reconfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReconfigurationPackage.TACTIC: {
				Tactic tactic = (Tactic)theEObject;
				T result = caseTactic(tactic);
				if (result == null) result = caseNamedElement(tactic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReconfigurationPackage.STRATEGY: {
			...
			case ReconfigurationPackage.NAMED_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Reconfiguration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reconfiguration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReconfiguration(Reconfiguration object) {
		return null;
	}
