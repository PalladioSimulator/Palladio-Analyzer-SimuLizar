...
public class reconfigurationruleAdapterFactory extends AdapterFactoryImpl {
    ...
    protected reconfigurationruleSwitch<Adapter> modelSwitch =
        new reconfigurationruleSwitch<Adapter>() {
            @Override
            public Adapter caseReconfigurationRuleSet(ReconfigurationRuleSet object) {
                return createReconfigurationRuleSetAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.simulizar.reconfigurationrule.ReconfigurationRuleSet <em>Reconfiguration Rule Set</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createReconfigurationRuleSetAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.simulizar.reconfigurationrule.ReconfigurationRule <em>Reconfiguration Rule</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
