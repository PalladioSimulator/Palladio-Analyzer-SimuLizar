...
public class ModelTransformationCache {
     ...
     */
    private ModelTransformationCache(ModelTransformationCache from) {
        this.cache = new HashMap<>();
        this.cache.putAll(from.cache);
        this.modelTransformationFactory = from.modelTransformationFactory;
    }
     ...
     * this one.
     * 
     * @return A {@link ModelTransformationCache} which is a snapshot of the current state of this
     *         instance.
     */
    public ModelTransformationCache snapshot() {
        return new ModelTransformationCache(this);
    }
