...
public class SimulizarConstants {
	...
	public static final String RECONFIGURATION_RULES_FILE = "reconfigurationRulesFile";
	...
	public static final String[] RECONFIGURATION_RULES_FILE_EXTENSION = new String[] { "*.reconfigurationruleset" };
	public static final String[] RECONFIGURATION_RULE_TRANSFORMATION_FILE_EXTENSION = new String[] { "*.sdm", ".qvto",
			".henshin" };
	...
	public static final String DEFAULT_RECONFIGURATION_RULES_FILE = "";
