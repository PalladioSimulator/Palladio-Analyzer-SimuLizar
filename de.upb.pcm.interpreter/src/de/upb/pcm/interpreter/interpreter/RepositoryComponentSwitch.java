...
class RepositoryComponentSwitch extends CompositionSwitch<SimulatedStackframe<Object>> {
	...
	public SimulatedStackframe<Object> caseBasicComponent(BasicComponent basicComponent) {
		...
		SimulatedStackframe<Object> result = interpretSeffs(calledSeffs);
	...
	public SimulatedStackframe<Object> caseProvidedRole(final ProvidedRole providedRole) {		
		...
		SimulatedStackframe<Object> result = this.doSwitch(providedRole.getProvidingEntity_ProvidedRole());
	 ...
	 *            a list of seffs.
	 */
	private SimulatedStackframe<Object> interpretSeffs(
