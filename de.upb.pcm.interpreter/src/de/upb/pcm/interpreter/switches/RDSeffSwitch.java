 ...
 */
public class RDSeffSwitch<T> extends SeffSwitch<T> implements
		IPCMModelSwitch<T> {
	...
	public T caseInternalAction(final InternalAction object) {
		...
		final AllocationAccess allocationReader = this.modelAcccessFactory.getAllocationAccess(
						context);
	 ...
	 */
	@Override
	public T caseResourceDemandingBehaviour(
	...
	private void initReponseTimeMeasurement(final ExternalCallAction object,
		...
		final PMSAccess pmsAccess = this.modelAcccessFactory.getPMSModelAccess();
