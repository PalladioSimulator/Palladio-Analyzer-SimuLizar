 ...
 */
public class AllocationAccess extends AbstractPCMModelAccess
{
    ...
    */
   @Override
   public Allocation getModel()
   {
      if (this.getSimProcess() != null)
      {
         return getModelHelper().getLocalPCMModels(this.getSimProcess()).getAllocation();
      }
      return getModelHelper().getGlobalPCMModels().getAllocation();
   }
}
