 ...
 * <ul>
 *   <li>{@link org.palladiosimulator.simulizar.prm.impl.PCMModelElementMeasurementImpl#getPcmModelElement <em>Pcm Model Element</em>}</li>
 *   <li>{@link org.palladiosimulator.simulizar.prm.impl.PCMModelElementMeasurementImpl#getMeasurementSpecification <em>Measurement Specification</em>}</li>
 *   <li>{@link org.palladiosimulator.simulizar.prm.impl.PCMModelElementMeasurementImpl#getMeasurementValue <em>Measurement Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PCMModelElementMeasurementImpl extends UniqueElementImpl implements PCMModelElementMeasurement
{
   ...
   /**
     * The default value of the '{@link #getMeasurementValue() <em>Measurement Value</em>}' attribute.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
   ...
   /**
     * The cached value of the '{@link #getMeasurementValue() <em>Measurement Value</em>}' attribute.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @see #getMeasurementValue()
     * @generated
     * @ordered
        ...
        if (pcmModelElement != null && pcmModelElement.eIsProxy()) {
            ...
            if (pcmModelElement != oldPcmModelElement) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrmPackage.PCM_MODEL_ELEMENT_MEASUREMENT__PCM_MODEL_ELEMENT, oldPcmModelElement, pcmModelElement));
            }
        }
   ...
   public void setPcmModelElement(EObject newPcmModelElement)
   {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PrmPackage.PCM_MODEL_ELEMENT_MEASUREMENT__PCM_MODEL_ELEMENT, oldPcmModelElement, pcmModelElement));
    }
   ...
   public MeasurementSpecification getMeasurementSpecification()
   {
        if (measurementSpecification != null && measurementSpecification.eIsProxy()) {
            ...
            if (measurementSpecification != oldMeasurementSpecification) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrmPackage.PCM_MODEL_ELEMENT_MEASUREMENT__MEASUREMENT_SPECIFICATION, oldMeasurementSpecification, measurementSpecification));
            }
        }
   ...
   public void setMeasurementSpecification(MeasurementSpecification newMeasurementSpecification)
   {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PrmPackage.PCM_MODEL_ELEMENT_MEASUREMENT__MEASUREMENT_SPECIFICATION, oldMeasurementSpecification, measurementSpecification));
    }
   ...
   public void setMeasurementValue(double newMeasurementValue)
   {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PrmPackage.PCM_MODEL_ELEMENT_MEASUREMENT__MEASUREMENT_VALUE, oldMeasurementValue, measurementValue));
    }
