...
/**
 * This is the item provider adapter for a {@link eurema.Layer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layer_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layer_number_feature", "_UI_Layer_type"),
				 EuremaPackage.Literals.LAYER__NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EuremaPackage.Literals.LAYER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EuremaPackage.Literals.LAYER__MODULES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EuremaPackage.Literals.LAYER__MODULES,
				 EuremaFactory.eINSTANCE.createSoftwareModule()));

		newChildDescriptors.add
			(createChildParameter
				(EuremaPackage.Literals.LAYER__MODULES,
				 EuremaFactory.eINSTANCE.createMegamodelModule()));
	}
