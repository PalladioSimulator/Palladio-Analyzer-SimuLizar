 ...
 * {@link org.palladiosimulator.simulizar.pms.PerformanceMeasurement} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PerformanceMeasurementItemProvider extends UniqueElementItemProvider implements
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addPcmElementClassifierPropertyDescriptor(object);
        }
        return itemPropertyDescriptors;
    }

    /**
     * This adds a property descriptor for the Pcm Element Classifier feature. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void addPcmElementClassifierPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_PerformanceMeasurement_pcmElementClassifier_feature"),
                getString("_UI_PropertyDescriptor_description",
                        "_UI_PerformanceMeasurement_pcmElementClassifier_feature", "_UI_PerformanceMeasurement_type"),
                PmsPackage.Literals.PERFORMANCE_MEASUREMENT__PCM_ELEMENT_CLASSIFIER, true, false, true, null, null,
                null));
    }
    ...
    /**
     * This returns PerformanceMeasurement.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_PerformanceMeasurement_type")
