...
public class RuntimeMeasurementItemProvider extends IdentifierItemProvider {
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/RuntimeMeasurement"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((RuntimeMeasurement) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_RuntimeMeasurement_type") : this
