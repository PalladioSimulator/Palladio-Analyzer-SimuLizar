 ...
 * <ul>
 *   <li>{@link de.upb.pcm.pms.UniqueElement#getGuid <em>Guid</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.upb.pcm.pms.PmsPackage#getUniqueElement()
 * @model
 * @generated
 */
public interface UniqueElement extends EObject
{
    ...
    * @see #setGuid(String)
    * @see de.upb.pcm.pms.PmsPackage#getUniqueElement_Guid()
    * @model
    * @generated
    */
   String getGuid();
   ...
   /**
    * Sets the value of the '{@link de.upb.pcm.pms.UniqueElement#getGuid <em>Guid</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
