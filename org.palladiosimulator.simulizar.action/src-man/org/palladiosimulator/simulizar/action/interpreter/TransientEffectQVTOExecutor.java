...
/**
 * Implementation of the {@link AbstractQVTOExecutor} suitable for executing
 * {@link AdaptationStep AdaptationSteps}, i.e., transient effects.
 * 
...
class TransientEffectQVTOExecutor extends AbstractQVTOExecutor {
	...
	final Optional<Mapping> executeControllerCompletion(Repository controllerCompletionRepository) {
		...
		Optional<EObject> cachedRepo = Optional.ofNullable(getAvailableModels().getModelByType(REPOSITORY_EPACKAGE));
