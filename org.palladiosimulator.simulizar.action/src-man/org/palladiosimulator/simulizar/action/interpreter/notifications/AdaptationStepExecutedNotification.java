...
public class AdaptationStepExecutedNotification extends NotificationImpl {
     ...
     * @param executedAdaptationStep The {@link AdaptationStep} that terminated successfully.
     * @throws NullPointerException In case {@code executedAdaptationStep} is {@code null}.
     */
