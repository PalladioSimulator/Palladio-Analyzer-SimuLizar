...
public class ActionRepositoryFileInputConfigBuilder extends AbstractExtensionFileInputConfigurationBuilder {
    ...
    public ExtensionFileInputConfiguration buildConfiguration() {
        ...
        properties
                .put(ExtensionFileInputConfiguration.DefaultPropertyKeys.CONFIG_ATTRIBUTE_NAME_KEY, ACTION_MODEL_FILE);
        ...
        properties.put(ExtensionFileInputConfiguration.DefaultPropertyKeys.DEFAULT_URI_KEY,
                LoadActionRepositoryIntoBlackboardJobConfig.DEFAULT_ACTION_REPOSITORY_PATH);
