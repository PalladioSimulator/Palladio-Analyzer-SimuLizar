 ...
 * <ul>
 * <li>
 * {@link org.palladiosimulator.simulizar.action.core.impl.AdaptationBehaviorImpl#getAdaptationSteps
 ...
 * @generated
 */
public class AdaptationBehaviorImpl extends EntityImpl implements AdaptationBehavior {
    /**
     ...
     * @ordered
     */
    protected EList<AdaptationAction> adaptationSteps;
     ...
     */
    @Override
    public EList<AdaptationAction> getAdaptationSteps() {
        if (this.adaptationSteps == null) {
            this.adaptationSteps = new EObjectContainmentWithInverseEList<AdaptationAction>(AdaptationAction.class,
                    this, CorePackage.ADAPTATION_BEHAVIOR__ADAPTATION_STEPS, CorePackage.ADAPTATION_ACTION__ACTION);
        }
    ...
    public boolean execute(final RoleSet affectedRoleSet) {
        return org.palladiosimulator.simulizar.action.interpreter.ActionRuntimeState
                .createTransientEffectInterpreter(affectedRoleSet, this.getRepository()).caseAdaptationBehavior(this);
    }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case CorePackage.ADAPTATION_BEHAVIOR__ADAPTATION_STEPS:
            ...
            this.getAdaptationSteps().addAll((Collection<? extends AdaptationAction>) newValue);
            return;
        case CorePackage.ADAPTATION_BEHAVIOR__INVOLVED_ROLES:
