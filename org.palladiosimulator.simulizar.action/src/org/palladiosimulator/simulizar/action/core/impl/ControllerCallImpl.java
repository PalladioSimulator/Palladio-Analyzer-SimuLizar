...
public class ControllerCallImpl extends EntityImpl implements ControllerCall {
		...
		if (component != null && ((EObject) component).eIsProxy()) {
			...
			if (component != oldComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.CONTROLLER_CALL__COMPONENT,
	...
	public void setComponent(BasicComponent newComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CONTROLLER_CALL__COMPONENT, oldComponent,
					component));
	}
			...
			if (calledSignature != oldCalledSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.CONTROLLER_CALL__CALLED_SIGNATURE, oldCalledSignature, calledSignature));
			}
		}
	...
	public void setCalledSignature(OperationSignature newCalledSignature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CONTROLLER_CALL__CALLED_SIGNATURE,
					oldCalledSignature, calledSignature));
	}
	...
	public ResourceDemandingStep getResourceDemandingStep() {
		if (eContainerFeatureID() != CorePackage.CONTROLLER_CALL__RESOURCE_DEMANDING_STEP)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetResourceDemandingStep(ResourceDemandingStep newResourceDemandingStep,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newResourceDemandingStep,
	...
	public void setResourceDemandingStep(ResourceDemandingStep newResourceDemandingStep) {
		if (newResourceDemandingStep != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.CONTROLLER_CALL__RESOURCE_DEMANDING_STEP
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CONTROLLER_CALL__RESOURCE_DEMANDING_STEP,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CorePackage.CONTROLLER_CALL__RESOURCE_DEMANDING_STEP:
			return eInternalContainer().eInverseRemove(this, CorePackage.RESOURCE_DEMANDING_STEP__CONTROLLER_CALLS,
