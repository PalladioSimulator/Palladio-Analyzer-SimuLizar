...
public class CoreAdapterFactory extends AdapterFactoryImpl {
    ...
    protected CoreSwitch<Adapter> modelSwitch = new CoreSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseGuardedAdaptationBehavior(final GuardedAdaptationBehavior object) {
            return CoreAdapterFactory.this.createGuardedAdaptationBehaviorAdapter();
        }
     ...
     * <em>Guarded Adaptation Behavior</em>}'. <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createGuardedAdaptationBehaviorAdapter() {
        return null;
    }
