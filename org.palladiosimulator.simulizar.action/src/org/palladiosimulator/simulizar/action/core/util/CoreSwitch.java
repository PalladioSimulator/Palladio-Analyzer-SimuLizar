...
public class CoreSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case CorePackage.GUARDED_ACTION: {
            final GuardedAction guardedAction = (GuardedAction) theEObject;
            T result = this.caseGuardedAction(guardedAction);
            if (result == null) {
                result = this.caseAdaptationAction(guardedAction);
            }
            if (result == null) {
                result = this.caseEntity(guardedAction);
            }
            if (result == null) {
                result = this.caseIdentifier(guardedAction);
            }
            if (result == null) {
                result = this.caseNamedElement(guardedAction);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }
     ...
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Abstract Adaptation Behavior</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
     ...
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Nested Adaptation Behavior</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
     ...
     * @generated
     */
    public T caseGuardedAction(final GuardedAction object) {
        return null;
    }
