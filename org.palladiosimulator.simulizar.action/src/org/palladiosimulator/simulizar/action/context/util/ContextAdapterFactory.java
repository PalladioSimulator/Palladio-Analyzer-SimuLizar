...
public class ContextAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ContextSwitch<Adapter> modelSwitch = new ContextSwitch<Adapter>() {
        @Override
        public Adapter caseExecutionContext(final ExecutionContext object) {
     ...
     * {@link org.palladiosimulator.simulizar.action.context.ExecutionContext
     * <em>Execution Context</em>}'. <!-- begin-user-doc --> This default implementation returns
