...
public class MappingPackageImpl extends EPackageImpl implements MappingPackage {
    ...
    public static MappingPackage init() {
        ...
        final MappingPackageImpl theMappingPackage = (MappingPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MappingPackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI)
    ...
    public void initializePackageContents() {
        ...
        this.initEReference(this.getControllerMapping_ControllerRole(),
        ...
        this.initEReference(this.getControllerMapping_Mapping(), this.getMapping(),
                this.getMapping_ControllerMappings(),
