 ...
 * <ul>
 * <li>{@link org.palladiosimulator.simulizar.action.instance.impl.RoleImpl#getRoleSet <em>Role Set
 * </em>}</li>
...
public class RoleImpl extends IdentifierImpl implements Role {
    ...
    public void setValue(final EObject newValue) {
        ...
        this.value = newValue;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.ROLE__VALUE, oldValue,
                    this.value));
        }
    }
