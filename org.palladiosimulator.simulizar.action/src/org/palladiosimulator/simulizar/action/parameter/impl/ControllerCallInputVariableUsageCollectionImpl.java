 ...
 * <ul>
 * <li>
 * {@link org.palladiosimulator.simulizar.action.parameter.impl.ControllerCallInputVariableUsageCollectionImpl#getControllerCallInputVariableUsages
...
public class ControllerCallInputVariableUsageCollectionImpl extends EntityImpl
    ...
    public EList<ControllerCallInputVariableUsage> getControllerCallInputVariableUsages() {
        if (this.controllerCallInputVariableUsages == null) {
            this.controllerCallInputVariableUsages = new EObjectContainmentWithInverseEList<ControllerCallInputVariableUsage>(
        ...
        return this.controllerCallInputVariableUsages;
    }
    ...
    public void eSet(final int featureID, final Object newValue) {
        switch (featureID) {
        case ParameterPackage.CONTROLLER_CALL_INPUT_VARIABLE_USAGE_COLLECTION__CONTROLLER_CALL_INPUT_VARIABLE_USAGES:
            this.getControllerCallInputVariableUsages().clear();
    ...
    public boolean eIsSet(final int featureID) {
        switch (featureID) {
        case ParameterPackage.CONTROLLER_CALL_INPUT_VARIABLE_USAGE_COLLECTION__CONTROLLER_CALL_INPUT_VARIABLE_USAGES:
            return this.controllerCallInputVariableUsages != null && !this.controllerCallInputVariableUsages.isEmpty();
        }
