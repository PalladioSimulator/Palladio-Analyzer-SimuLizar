 ...
 *   <li>{@link org.palladiosimulator.simulizar.pms.impl.PerformanceMeasurementImpl#getMeasuringPoint <em>Measuring Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
        ...
        if (measuringPoint != null && measuringPoint.eIsProxy()) {
            ...
            if (measuringPoint != oldMeasuringPoint) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmsPackage.PERFORMANCE_MEASUREMENT__MEASURING_POINT, oldMeasuringPoint, measuringPoint));
            }
        }
...
/**
    ...
    public void setMeasuringPoint(MeasuringPoint newMeasuringPoint) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PmsPackage.PERFORMANCE_MEASUREMENT__MEASURING_POINT, oldMeasuringPoint, measuringPoint));
    }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType)
   {
        switch (featureID) {
            ...
            case PmsPackage.PERFORMANCE_MEASUREMENT__MEASURING_POINT:
                if (resolve) return getMeasuringPoint();
