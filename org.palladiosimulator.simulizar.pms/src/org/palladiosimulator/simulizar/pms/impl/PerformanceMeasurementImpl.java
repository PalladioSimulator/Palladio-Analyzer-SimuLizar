 ...
 * <li>
 * {@link org.palladiosimulator.simulizar.pms.impl.PerformanceMeasurementImpl#getPcmElementClassifier
 * <em>Pcm Element Classifier</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PerformanceMeasurementImpl extends UniqueElementImpl implements PerformanceMeasurement {
    ...
    /**
     * The cached value of the '{@link #getPcmElementClassifier() <em>Pcm Element Classifier</em>}'
            ...
            if (pcmElementClassifier != oldPcmElementClassifier) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            PmsPackage.PERFORMANCE_MEASUREMENT__PCM_ELEMENT_CLASSIFIER, oldPcmElementClassifier,
                            pcmElementClassifier));
            }
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case PmsPackage.PERFORMANCE_MEASUREMENT__PCM_ELEMENT_CLASSIFIER:
            if (resolve)
                return getPcmElementClassifier();
