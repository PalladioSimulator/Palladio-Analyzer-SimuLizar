 ...
 * <ul>
 * <li>{@link org.palladiosimulator.simulizar.pms.impl.MonitorImpl#getMeasurementSpecification <em>
 * Measurement Specification</em>}</li>
 * <li>{@link org.palladiosimulator.simulizar.pms.impl.MonitorImpl#getMeasuringPoint <em>Measuring
 * Point</em>}</li>
 * </ul>
 * </p>
 *
...
public class MonitorImpl extends EntityImpl implements Monitor {
    ...
    protected EClass eStaticClass() {
        return PmsPackage.Literals.MONITOR;
    }
    ...
    public EList<MeasurementSpecification> getMeasurementSpecification() {
        if (this.measurementSpecification == null) {
            this.measurementSpecification = new EObjectContainmentEList<MeasurementSpecification>(
                    MeasurementSpecification.class, this, PmsPackage.MONITOR__MEASUREMENT_SPECIFICATION);
        }
        ...
        if (this.measuringPoint != null && this.measuringPoint.eIsProxy()) {
            ...
            if (this.measuringPoint != oldMeasuringPoint) {
                if (this.eNotificationRequired()) {
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmsPackage.MONITOR__MEASURING_POINT,
    ...
    public void setMeasuringPoint(final MeasuringPoint newMeasuringPoint) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, PmsPackage.MONITOR__MEASURING_POINT,
                    oldMeasuringPoint, this.measuringPoint));
        }
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
        ...
        switch (featureID) {
        case PmsPackage.MONITOR__MEASUREMENT_SPECIFICATION:
    ...
    public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
        ...
        case PmsPackage.MONITOR__MEASURING_POINT:
            if (resolve) {
