...
public final class MonitorRepositoryUtil {
	...
	private static EObject getEObjectFromPCMMeasuringPoint(MeasuringPoint measuringPoint) {
		...
		return new PcmmeasuringpointSwitch<EObject>() {
			...
			/**
			 * FIXME We stick to single model elements here even though several
			 * would be needed to uniquely identify the measuring point of
			 * interest (system + role + signature). [Lehrig]
			 */
			@Override
