...
import org.palladiosimulator.simulizar.interpreter.listener.ProbeFrameworkListenerBasic;
 ...
 *
 */
public class SimuLizarRuntimeStateBasic extends SimuLizarRuntimeState {
     ...
     * @param modelAccess
     */
    public SimuLizarRuntimeStateBasic(final SimuLizarWorkflowConfiguration configuration, final ModelAccess modelAccess) {
    ...
    protected void initializeInterpreterListeners(final Reconfigurator reconfigurator) {
        ...
        this.eventHelper.addObserver(new ProbeFrameworkListenerBasic(this.getModelAccess(), this.getModel(), reconfigurator));
    }
}
