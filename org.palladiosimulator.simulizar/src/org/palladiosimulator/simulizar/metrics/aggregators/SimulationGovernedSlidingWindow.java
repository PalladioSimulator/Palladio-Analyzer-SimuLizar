 ...
 */
public class SimulationGovernedSlidingWindow extends SlidingWindow {

    private ISimulationControl simControl = null;

    /**
     * Initializes a new instance of the {@link SimulationGovernedSlidingWindow} class with the
     * given parameters.
     * 
     * @param windowLength
     ...
     *             </ul>
     */
    public SimulationGovernedSlidingWindow(Measure<Double, Duration> windowLength, Measure<Double, Duration> increment,
    ...
    private void initializeTriggeredSimulationEntity(SimuComModel model) {
        ...
        // in sec
        new PeriodicallyTriggeredSimulationEntity(model, SimulationGovernedSlidingWindow.this
                .getSpecifiedWindowLength().doubleValue(SI.SECOND), SimulationGovernedSlidingWindow.this.getIncrement()
