 ...
 * of models exist: global models like the central PCM model, the PMS model, the
 * PRM model, or all reconfiguration rules provided in various models. The
 * second class of models are read-only copies of a subset of the global models
 * provided to each simulated process/thread when it starts to execute.
 * 
