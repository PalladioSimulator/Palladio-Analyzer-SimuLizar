...
/**
 * This is the item provider adapter for a {@link violations.Violation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Violation_violationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Violation_violationType_feature", "_UI_Violation_type"),
				 ViolationsPackage.Literals.VIOLATION__VIOLATION_TYPE,
				 true,
				 false,
				 true,
				 null,
