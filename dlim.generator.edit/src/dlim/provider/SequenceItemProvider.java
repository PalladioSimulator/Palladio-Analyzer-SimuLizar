...
/**
 * This is the item provider adapter for a {@link dlim.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addTerminateAfterTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_terminateAfterTime_feature") + " (s)",
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_terminateAfterTime_feature", "_UI_Sequence_type"),
				 DlimPackage.Literals.SEQUENCE__TERMINATE_AFTER_TIME,
				 true,
				 false,
				 false,
