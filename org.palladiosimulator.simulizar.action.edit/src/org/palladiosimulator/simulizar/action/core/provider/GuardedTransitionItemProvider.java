...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.simulizar.action.core.GuardedTransition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GuardedTransitionItemProvider extends EntityItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConditionURIPropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addConditionURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GuardedTransition_conditionURI_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_GuardedTransition_conditionURI_feature",
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.GUARDED_TRANSITION__NESTED_ADAPTATION_BEHAVIOR);
		}
	...
	public String getText(Object object) {
		String label = ((GuardedTransition) object).getEntityName();
		return label == null || label.length() == 0 ? getString("_UI_GuardedTransition_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.GUARDED_TRANSITION__NESTED_ADAPTATION_BEHAVIOR,
