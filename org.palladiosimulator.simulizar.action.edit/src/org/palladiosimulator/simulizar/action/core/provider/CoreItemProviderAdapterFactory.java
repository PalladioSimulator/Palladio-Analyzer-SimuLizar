...
public class CoreItemProviderAdapterFactory extends CoreAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
     * This keeps track of the one adapter used for all {@link org.palladiosimulator.simulizar.action.core.Action} instances.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	...
	/**
     * This keeps track of the one adapter used for all {@link org.palladiosimulator.simulizar.action.core.ActionRepository} instances.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	...
	/**
     * This creates an adapter for a {@link org.palladiosimulator.simulizar.action.core.ActionRepository}.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	...
	public Adapter createActionRepositoryAdapter() {
        if (actionRepositoryItemProvider == null) {
            actionRepositoryItemProvider = new ActionRepositoryItemProvider(this);
        }

        return actionRepositoryItemProvider;
    }
	...
	public void dispose() {
        ...
        if (resourceDemandingStepItemProvider != null) resourceDemandingStepItemProvider.dispose();
        if (roleTypeItemProvider != null) roleTypeItemProvider.dispose();
        if (actionRepositoryItemProvider != null) actionRepositoryItemProvider.dispose();
        if (controllerCallItemProvider != null) controllerCallItemProvider.dispose();
    }
