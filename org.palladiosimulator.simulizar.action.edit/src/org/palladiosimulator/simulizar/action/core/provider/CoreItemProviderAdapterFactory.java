...
public class CoreItemProviderAdapterFactory extends CoreAdapterFactory
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.palladiosimulator.simulizar.action.core.GuardedAdaptationBehavior} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected GuardedAdaptationBehaviorItemProvider guardedAdaptationBehaviorItemProvider;
    ...
    public Adapter createGuardedAdaptationBehaviorAdapter() {
        if (this.guardedAdaptationBehaviorItemProvider == null) {
            this.guardedAdaptationBehaviorItemProvider = new GuardedAdaptationBehaviorItemProvider(this);
        }

        return this.guardedAdaptationBehaviorItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (this.guardedAdaptationBehaviorItemProvider != null) {
            this.guardedAdaptationBehaviorItemProvider.dispose();
        }
        if (this.enactAdaptationActionItemProvider != null) {
