...
public class RoleTypeItemProvider extends EntityItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RoleType_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_RoleType_type_feature",
								"_UI_RoleType_type"),
	...
	public String getText(Object object) {
		String label = ((RoleType) object).getEntityName();
