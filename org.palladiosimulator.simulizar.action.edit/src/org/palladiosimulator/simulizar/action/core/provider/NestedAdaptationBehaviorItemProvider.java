...
public class NestedAdaptationBehaviorItemProvider extends AbstractAdaptationBehaviorItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NestedAdaptationBehavior"));
	}
	...
	public String getText(Object object) {
		String label = ((NestedAdaptationBehavior) object).getEntityName();
		return label == null || label.length() == 0 ? getString("_UI_NestedAdaptationBehavior_type")
				: getString("_UI_NestedAdaptationBehavior_type") + " " + label;
	}
