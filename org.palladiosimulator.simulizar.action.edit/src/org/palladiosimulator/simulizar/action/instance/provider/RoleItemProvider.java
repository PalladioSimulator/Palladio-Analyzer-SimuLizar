...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.simulizar.action.instance.Role} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class RoleItemProvider extends IdentifierItemProvider {
	...
	protected void addRoleTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						InstancePackage.Literals.ROLE__ROLE_TYPE, true, false, true, null, null, null));
	}
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Role_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Role_value_feature", "_UI_Role_type"),
						InstancePackage.Literals.ROLE__VALUE, true, false, true, null, null, null));
	}
