...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.simulizar.action.instance.RoleSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleSetItemProvider extends IdentifierItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InstancePackage.Literals.ROLE_SET__ROLES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoleSet"));
	}
	...
	public String getText(Object object) {
		String label = ((RoleSet) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_RoleSet_type")
				: getString("_UI_RoleSet_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(InstancePackage.Literals.ROLE_SET__ROLES, InstanceFactory.eINSTANCE.createRole()));
	}
