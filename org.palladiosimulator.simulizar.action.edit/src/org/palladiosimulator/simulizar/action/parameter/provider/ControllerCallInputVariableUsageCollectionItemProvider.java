...
public class ControllerCallInputVariableUsageCollectionItemProvider extends EntityItemProvider {
     ...
     * @generated
     */
    public ControllerCallInputVariableUsageCollectionItemProvider(final AdapterFactory adapterFactory) {
    ...
    /**
     * This returns ControllerCallInputVariableUsageCollection.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object,
                this.getResourceLocator().getImage("full/obj16/ControllerCallInputVariableUsageCollection"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((ControllerCallInputVariableUsageCollection) object).getId();
        return label == null || label.length() == 0
                ? this.getString("_UI_ControllerCallInputVariableUsageCollection_type")
                : this.getString("_UI_ControllerCallInputVariableUsageCollection_type") + " " + label;
    }
