...
public class MappingItemProvider extends EntityItemProvider {
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_Mapping_type")
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(MappingPackage.Literals.MAPPING__CONTROLLER_MAPPINGS,
