...
public class ControllerMappingItemProvider extends EntityItemProvider {
	...
	protected void addMappedCallPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ControllerMapping_mappedCall_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ControllerMapping_mappedCall_feature",
	...
	protected void addControllerRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ControllerMapping_controllerRole_feature",
						"_UI_ControllerMapping_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ControllerMapping_type")
