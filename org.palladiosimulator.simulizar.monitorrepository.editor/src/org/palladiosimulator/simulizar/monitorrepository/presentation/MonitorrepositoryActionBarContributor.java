...
ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
            MonitorrepositoryEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("monitorrepository-settings"));
        toolBarManager.add(new Separator("monitorrepository-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ...
                "org.palladiosimulator.simulizar.monitorrepositoryMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                MonitorrepositoryEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                MonitorrepositoryEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(MonitorrepositoryEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
