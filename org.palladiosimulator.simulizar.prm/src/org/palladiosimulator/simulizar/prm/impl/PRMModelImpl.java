...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PRM Model</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.palladiosimulator.simulizar.prm.impl.PRMModelImpl#getPcmModelElementMeasurements <em>Pcm Model Element Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
{
   /**
     * The cached value of the '{@link #getPcmModelElementMeasurements() <em>Pcm Model Element Measurements</em>}' containment reference list.
     * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   public EList<PCMModelElementMeasurement> getPcmModelElementMeasurements()
   {
        if (pcmModelElementMeasurements == null) {
            pcmModelElementMeasurements = new EObjectContainmentEList<PCMModelElementMeasurement>(PCMModelElementMeasurement.class, this, PrmPackage.PRM_MODEL__PCM_MODEL_ELEMENT_MEASUREMENTS);
        }
