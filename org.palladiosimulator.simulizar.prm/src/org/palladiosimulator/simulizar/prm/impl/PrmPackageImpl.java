...
public class PrmPackageImpl extends EPackageImpl implements PrmPackage {
    ...
    public static PrmPackage init() {
        ...
        PrmPackageImpl thePrmPackage = (PrmPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PrmPackageImpl ? EPackage.Registry.INSTANCE
    ...
    public void initializePackageContents() {
        ...
        initEReference(getPRMModel_PcmModelElementMeasurements(), this.getPCMModelElementMeasurement(), null,
                "pcmModelElementMeasurements", null, 0, -1, PRMModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(pcmModelElementMeasurementEClass, PCMModelElementMeasurement.class, "PCMModelElementMeasurement",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getPCMModelElementMeasurement_PcmModelElement(), ecorePackage.getEObject(), null,
                "pcmModelElement", null, 0, 1, PCMModelElementMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPCMModelElementMeasurement_MeasurementSpecification(),
                thePmsPackage.getMeasurementSpecification(), null, "measurementSpecification", null, 0, 1,
                PCMModelElementMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getPCMModelElementMeasurement_MeasurementValue(), ecorePackage.getEDouble(), "measurementValue",
                "0.0", 0, 1, PCMModelElementMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
        ...
        initEClass(resourceContainerMeasurementEClass, ResourceContainerMeasurement.class,
