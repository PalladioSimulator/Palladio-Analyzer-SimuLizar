...
import de.upb.pcm.prm.util.PrmAdapterFactory;
 ...
 * @generated
 */
public class PrmItemProviderAdapterFactory extends PrmAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable
{
   /**
   ...
   /**
    * This keeps track of the one adapter used for all {@link de.upb.pcm.prm.PRMModel} instances.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   /**
    * This creates an adapter for a {@link de.upb.pcm.prm.PRMModel}.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   /**
    * This keeps track of the one adapter used for all {@link de.upb.pcm.prm.PCMModelElementMeasurement} instances.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   /**
    * This creates an adapter for a {@link de.upb.pcm.prm.PCMModelElementMeasurement}.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   /**
    * This keeps track of the one adapter used for all {@link de.upb.pcm.prm.UniqueElement} instances.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   /**
    * This creates an adapter for a {@link de.upb.pcm.prm.UniqueElement}.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   /**
    * This keeps track of the one adapter used for all {@link de.upb.pcm.prm.ResourceContainerMeasurement} instances.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   /**
    * This creates an adapter for a {@link de.upb.pcm.prm.ResourceContainerMeasurement}.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   public void dispose()
   {
      if (prmModelItemProvider != null) prmModelItemProvider.dispose();
      if (pcmModelElementMeasurementItemProvider != null) pcmModelElementMeasurementItemProvider.dispose();
      if (uniqueElementItemProvider != null) uniqueElementItemProvider.dispose();
      if (resourceContainerMeasurementItemProvider != null) resourceContainerMeasurementItemProvider.dispose();
   }
