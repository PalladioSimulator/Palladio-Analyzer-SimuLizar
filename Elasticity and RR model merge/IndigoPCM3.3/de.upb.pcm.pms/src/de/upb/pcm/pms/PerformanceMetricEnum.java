...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Performance Metric Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see de.upb.pcm.pms.PmsPackage#getPerformanceMetricEnum()
 * @model
 * @generated
 */
public enum PerformanceMetricEnum implements Enumerator
{
   ...
   /**
    * The '<em><b>Arrival Rate</b></em>' literal object.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * <!-- begin-user-doc -->
    * <p>
    * If the meaning of '<em><b>Arrival Rate</b></em>' literal object isn't clear,
    * there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * @see #ARRIVAL_RATE
    ...
    * @generated
    */
   private static final PerformanceMetricEnum[] VALUES_ARRAY =
      new PerformanceMetricEnum[]
      {
         WAITING_TIME,
         RESPONSE_TIME,
         UTILIZATION,
