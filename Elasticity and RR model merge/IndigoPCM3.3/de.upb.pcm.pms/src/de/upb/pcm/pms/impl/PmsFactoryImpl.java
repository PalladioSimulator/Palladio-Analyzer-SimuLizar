...
public class PmsFactoryImpl extends EFactoryImpl implements PmsFactory
{
   ...
   public static PmsFactory init()
   {
      try
      {
         PmsFactory thePmsFactory = (PmsFactory)EPackage.Registry.INSTANCE.getEFactory("http:///de/upb/pcm/pms/model/pms.ecore"); 
   ...
   public EObject create(EClass eClass)
   {
      ...
      {
         case PmsPackage.PMS_MODEL: return createPMSModel();
         case PmsPackage.PERFORMANCE_MEASUREMENT: return createPerformanceMeasurement();
         case PmsPackage.MEASUREMENT_SPECIFICATION: return createMeasurementSpecification();
         case PmsPackage.INTERVALL: return createIntervall();
         case PmsPackage.DELAYED_INTERVALL: return createDelayedIntervall();
         case PmsPackage.TIME_FRAME: return createTimeFrame();
         case PmsPackage.UNIQUE_ELEMENT: return createUniqueElement();
         default:
    ...
    * @generated
    */
   public StatisticalCharacterizationEnum createStatisticalCharacterizationEnumFromString(EDataType eDataType, String initialValue)
   {
