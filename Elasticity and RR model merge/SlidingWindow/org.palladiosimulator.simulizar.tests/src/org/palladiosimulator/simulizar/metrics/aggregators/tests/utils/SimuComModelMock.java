package org.palladiosimulator.simulizar.metrics.aggregators.tests.utils;
...
public class SimuComModelMock extends SimuComModel {
    ...
    public void triggerMockWindowMoveOn(SimulationGovernedSlidingWindow window) {
    ...
    private static class MockWindowMoveOnTriggeredEvent extends PeriodicallyTriggeredSimulationEntity {
        private final SimulationGovernedSlidingWindow window;

        private MockWindowMoveOnTriggeredEvent(SimuComModel model, SimulationGovernedSlidingWindow window) {
