 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.simulizar.reconfiguration.impl.ReconfigurationImpl#getStrategies <em>Strategies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReconfigurationImpl extends NamedElementImpl implements Reconfiguration {
	...
	protected EClass eStaticClass() {
		return ReconfigurationPackage.Literals.RECONFIGURATION;
	}
	...
	public EList<Strategy> getStrategies() {
		if (strategies == null) {
			strategies = new EObjectContainmentEList<Strategy>(Strategy.class, this, ReconfigurationPackage.RECONFIGURATION__STRATEGIES);
		}
		return strategies;
	}
