...
/**
 * This is the item provider adapter for a {@link eurema.Architecture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchitectureItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EuremaPackage.Literals.ARCHITECTURE__LAYERS);
			childrenFeatures.add(EuremaPackage.Literals.ARCHITECTURE__MODEL_RESOURCE_SET);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EuremaPackage.Literals.ARCHITECTURE__LAYERS,
				 EuremaFactory.eINSTANCE.createLayer()));

		newChildDescriptors.add
			(createChildParameter
				(EuremaPackage.Literals.ARCHITECTURE__MODEL_RESOURCE_SET,
				 EuremaFactory.eINSTANCE.createModelResourceSet()));
	}
