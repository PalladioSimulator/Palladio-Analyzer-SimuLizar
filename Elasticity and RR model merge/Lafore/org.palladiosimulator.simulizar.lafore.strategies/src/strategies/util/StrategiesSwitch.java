 ...
 * @generated
 */
public class StrategiesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StrategiesPackage.STRATEGY_TYPE: {
				StrategyType strategyType = (StrategyType)theEObject;
				T result = caseStrategyType(strategyType);
				if (result == null) result = caseResourceDemandingSEFF(strategyType);
				if (result == null) result = caseEntity(strategyType);
				if (result == null) result = caseServiceEffectSpecification(strategyType);
				if (result == null) result = caseResourceDemandingBehaviour(strategyType);
				if (result == null) result = caseNamedElement(strategyType);
				if (result == null) result = caseIdentifier(strategyType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StrategiesPackage.RECONFIGURATION_ACTION: {
				...
				if (result == null) result = caseInternalAction(reconfigurationAction);
				if (result == null) result = caseAbstractInternalControlFlowAction(reconfigurationAction);
				if (result == null) result = caseAbstractAction(reconfigurationAction);
				if (result == null) result = caseEntity(reconfigurationAction);
				if (result == null) result = caseIdentifier(reconfigurationAction);
				if (result == null) result = caseNamedElement(reconfigurationAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StrategiesPackage.STRATEGIES_REPOSITORY: {
				StrategiesRepository strategiesRepository = (StrategiesRepository)theEObject;
				T result = caseStrategiesRepository(strategiesRepository);
				if (result == null) result = caseBasicComponent(strategiesRepository);
				if (result == null) result = caseImplementationComponentType(strategiesRepository);
				if (result == null) result = caseRepositoryComponent(strategiesRepository);
				if (result == null) result = caseInterfaceProvidingRequiringEntity(strategiesRepository);
				if (result == null) result = caseInterfaceProvidingEntity(strategiesRepository);
				if (result == null) result = caseInterfaceRequiringEntity(strategiesRepository);
				if (result == null) result = caseResourceInterfaceRequiringEntity(strategiesRepository);
				if (result == null) result = caseEntity(strategiesRepository);
				if (result == null) result = caseIdentifier(strategiesRepository);
				if (result == null) result = caseNamedElement(strategiesRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Runtime Strategies Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Runtime Strategies Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRuntimeStrategiesModel(RuntimeStrategiesModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Strategy Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Strategy Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStrategyType(StrategyType object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseStrategiesRepository(StrategiesRepository object) {
		return null;
	}
