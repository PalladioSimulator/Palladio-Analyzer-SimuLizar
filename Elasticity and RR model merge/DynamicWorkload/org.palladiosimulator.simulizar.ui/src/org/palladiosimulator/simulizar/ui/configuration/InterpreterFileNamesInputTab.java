...
public class InterpreterFileNamesInputTab extends ProtocomFileNamesInputTab {
    ...
    /** Text field for path to dynamic environment (workload) model file. */
	protected Text demFile;
    ...
    public void createControl(final Composite parent) {
        ...
        /**
         * Create dynamic environment model file section
         */
        demFile = new Text(container, SWT.SINGLE | SWT.BORDER);
		TabHelper.createFileInputSection(container, modifyListener, "Select Dynamic Environment (Workload) Model File", SimulizarConstants.DEM_FILE_EXTENSION, demFile, "Select Dynamic Environment File", getShell(), SimulizarConstants.DEFAULT_DEM_FILE);
    ...
    public void initializeFrom(final ILaunchConfiguration configuration) {
        ...
        try {
        	demFile.setText(configuration.getAttribute(
        			SimulizarConstants.DEM_FILE, SimulizarConstants.DEFAULT_DEM_FILE));
		} catch (CoreException e) {
			LaunchConfigPlugin.errorLogger(getName(),"Dynamic Environment File", e.getMessage());
		}
    ...
    public void performApply(final ILaunchConfigurationWorkingCopy configuration) {
        ...
        configuration.setAttribute(SimulizarConstants.DEM_FILE, demFile
				.getText());
    }
    ...
    public void setDefaults(final ILaunchConfigurationWorkingCopy configuration) {
        ...
        configuration.setAttribute(SimulizarConstants.RECONFIGURATION_RULES_FOLDER,
                SimulizarConstants.DEFAULT_RECONFIGURATION_RULES_FOLDER);
        configuration.setAttribute(SimulizarConstants.DEM_FILE,
                SimulizarConstants.DEFAULT_DEM_FILE);
    }
