...
public class SimuLizarWorkflowConfiguration extends
	...
	protected Object clone() throws CloneNotSupportedException {
		SimuLizarWorkflowConfiguration config = (SimuLizarWorkflowConfiguration) super
				.clone();
		config.pmsFile = this.pmsFile;
		config.reconfigurationRulesFolder = this.reconfigurationRulesFolder;
		config.demFile = this.demFile;
		return config;
	}
