   ...
   protected defaultrepository.ILastverteiler m_portAngeboten_ILastverteiler = null;
	              ...
	              
    {
		...
		// Wait for system
		m_portAngeboten_ILastverteiler = (defaultrepository.ILastverteiler)de.uka.ipd.sdq.prototype.framework.registry.RmiRegistry.lookup("ILastverteiler_EntpackerService");
	}
