...
implements ISelectionChangedListener {
            ...
            new Action(ActionsEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        public void run()
        {
            ...
            {
                final Viewer viewer = ((IViewerProvider) CoreActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ActionsEditorPlugin.INSTANCE.getString("_UI_CoreEditor_menu"),
                "org.palladiosimulator.simulizar.action.coreMenuID");
