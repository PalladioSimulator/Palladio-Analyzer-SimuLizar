...
/**
 * This is the action bar contributor for the Instance model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
...
implements ISelectionChangedListener {
            ...
            new Action(ActionsEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                InstanceActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
            ...
            new Action(ActionsEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        public void run()
        {
            if (InstanceActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) InstanceActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ActionsEditorPlugin.INSTANCE.getString("_UI_InstanceEditor_menu"),
                "org.palladiosimulator.simulizar.action.instanceMenuID");
