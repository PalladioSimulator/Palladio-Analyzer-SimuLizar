...
implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction =
            new Action(ActionsEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        @Override
        public void run()
        {
    ...
    protected IAction refreshViewerAction =
            new Action(ActionsEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        @Override
        ...
        public void run()
        {
            ...
            {
                final Viewer viewer = ((IViewerProvider) MappingActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
