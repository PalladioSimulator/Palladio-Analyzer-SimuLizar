...
/**
 * This is the action bar contributor for the Mapping model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class MappingActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                MappingActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return MappingActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (MappingActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) MappingActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ActionsEditorPlugin.INSTANCE.getString("_UI_MappingEditor_menu"),
                "org.palladiosimulator.simulizar.action.mappingMenuID");
