...
import org.palladiosimulator.simulizar.metrics.aggregators.ReconfigurationAggregator;
...
public class ProbeFrameworkListener extends AbstractInterpreterListener {
    ...
    private void initReconfigurationTimeMeasurement() {
        for (final MeasurementSpecification reconfigurationTimeMeasurementSpec : this
            ...
            Calculator buildReconfigurationTimeCalculator = this.calculatorFactory.buildReconfigurationTimeCalculator(measuringPoint, probe);
            buildReconfigurationTimeCalculator.addObserver(new ReconfigurationAggregator(this.getRuntimeMeasurementModel(), reconfigurationTimeMeasurementSpec, buildReconfigurationTimeCalculator, measuringPoint));
        }
    }
