...
public class Reconfigurator extends
	...
	public Reconfigurator(SimuComModel model,
		...
		this.reconfigurationProcess = new ReconfigurationProcess(this.model,
				this.reconfigurators, this);
	}
	...
	protected void checkAndExecuteReconfigurations(
		...
		if (isNotificationNewMeasurement(monitoredElement)
				&& !this.reconfigurationProcess.isScheduled()) {
			this.reconfigurationProcess
					.executeReconfigurations(runtimeMeasurementModel);
		}
	}
	...
	void fireReconfigurationEvent(
			ReconfigurationExecutedEvent reconfigurationExecutedEvent) {
		this.getEventDispatcher().reconfigurationExecuted(
