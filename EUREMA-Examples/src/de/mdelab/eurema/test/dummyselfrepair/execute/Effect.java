package de.mdelab.eurema.test.dummyselfrepair.execute;
...
public class Effect implements IModelOperation {
	...
	public ModelOperationResult run(List<Resource> models) {
		...
		ModelOperationResult result = new ModelOperationResult("done", output);
