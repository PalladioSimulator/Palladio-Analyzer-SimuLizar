...
<de.fzi.power:PowerModelRepository xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:de.fzi.power="http://www.fzi.de/Power/Specification/1.0" id="_bOxcMH1gEeWUt_x9QCHofA">
  ...
  <powerModelSpecifications xsi:type="de.fzi.power:DeclarativeDistributionPowerModelSpecification" id="_on3u0n1hEeWs5NTiSBh3Qw" name="Declarative Linear Passthrough Model (Test)" functionalExpression="SUM(Consumers)+ConstantLoss">
