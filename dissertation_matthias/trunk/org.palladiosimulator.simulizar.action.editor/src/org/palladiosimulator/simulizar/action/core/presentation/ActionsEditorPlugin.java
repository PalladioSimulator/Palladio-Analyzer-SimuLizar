...
/**
 * This is the central singleton for the Actions editor plugin. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public final class ActionsEditorPlugin extends EMFPlugin {
    /**
     * Keep track of the singleton. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    public static final ActionsEditorPlugin INSTANCE = new ActionsEditorPlugin();
