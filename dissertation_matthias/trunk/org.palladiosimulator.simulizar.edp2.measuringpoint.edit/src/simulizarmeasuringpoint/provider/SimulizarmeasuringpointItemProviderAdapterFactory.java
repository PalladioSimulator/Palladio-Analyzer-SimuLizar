...
import simulizarmeasuringpoint.util.SimulizarmeasuringpointAdapterFactory;
...
public class SimulizarmeasuringpointItemProviderAdapterFactory extends SimulizarmeasuringpointAdapterFactory implements
     ...
     * @generated
     */
    public SimulizarmeasuringpointItemProviderAdapterFactory() {
     ...
     * {@link simulizarmeasuringpoint.ReconfigurationMeasuringPoint} instances. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected ReconfigurationMeasuringPointItemProvider reconfigurationMeasuringPointItemProvider;

    /**
     * This creates an adapter for a {@link simulizarmeasuringpoint.ReconfigurationMeasuringPoint}.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public Adapter createReconfigurationMeasuringPointAdapter() {
        if (this.reconfigurationMeasuringPointItemProvider == null) {
            this.reconfigurationMeasuringPointItemProvider = new ReconfigurationMeasuringPointItemProvider(this);
        }

        return this.reconfigurationMeasuringPointItemProvider;
    }
    ...
    public void dispose() {
        if (this.reconfigurationMeasuringPointItemProvider != null) {
            this.reconfigurationMeasuringPointItemProvider.dispose();
        }
    }
        ...
        protected static class CreationSwitch extends MeasuringpointSwitch<Object> {
            ...
            public Object caseMeasuringPointRepository(final MeasuringPointRepository object) {
                this.newChildDescriptors.add(this.createChildParameter(
                        ...
                        SimulizarmeasuringpointFactory.eINSTANCE.createReconfigurationMeasuringPoint()));
