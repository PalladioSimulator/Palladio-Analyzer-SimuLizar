...
/**
 * This is the central singleton for the Simulizarmeasuringpoint edit plugin. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public final class SimulizarmeasuringpointEditPlugin extends EMFPlugin {
    /**
     * Keep track of the singleton. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    public static final SimulizarmeasuringpointEditPlugin INSTANCE = new SimulizarmeasuringpointEditPlugin();
     ...
     * @generated
     */
    public SimulizarmeasuringpointEditPlugin() {
