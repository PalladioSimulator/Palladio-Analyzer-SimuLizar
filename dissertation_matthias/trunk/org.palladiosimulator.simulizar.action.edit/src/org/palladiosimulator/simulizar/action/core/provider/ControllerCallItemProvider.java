...
public class ControllerCallItemProvider extends EntityItemProvider {
    ...
    protected void addComponentPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_ControllerCall_component_feature",
    ...
    protected void addCalledSignaturePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_ControllerCall_calledSignature_feature",
                        "_UI_ControllerCall_type"),
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ControllerCall_type")
