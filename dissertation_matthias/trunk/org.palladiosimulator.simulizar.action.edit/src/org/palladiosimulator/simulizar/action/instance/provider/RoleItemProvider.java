...
public class RoleItemProvider extends IdentifierItemProvider {
    ...
    protected void addRoleTypePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this
                .createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                        this.getResourceLocator(), this.getString("_UI_Role_roleType_feature"),
    ...
    protected void addValuePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_Role_value_feature", "_UI_Role_type"),
