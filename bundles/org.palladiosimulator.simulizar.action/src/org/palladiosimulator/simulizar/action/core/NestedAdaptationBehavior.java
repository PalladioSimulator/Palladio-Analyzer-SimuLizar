...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Nested Adaptation Behavior</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface NestedAdaptationBehavior extends AbstractAdaptationBehavior {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Guarded Transition</em>' container reference isn't clear,
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.simulizar.action.core.NestedAdaptationBehavior#getGuardedTransition <em>Guarded Transition</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Guarded Transition</em>' container reference.
