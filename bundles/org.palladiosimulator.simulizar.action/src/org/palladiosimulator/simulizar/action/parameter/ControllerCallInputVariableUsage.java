...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Controller Call Input
 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.simulizar.action.parameter.ControllerCallInputVariableUsage#getVariableUsage
 * <em>Variable Usage</em>}</li>
 * <li>{@link org.palladiosimulator.simulizar.action.parameter.ControllerCallInputVariableUsage#getCorrespondingControllerCall
 * <em>Corresponding Controller Call</em>}</li>
 * <li>{@link org.palladiosimulator.simulizar.action.parameter.ControllerCallInputVariableUsage#getContainingCollection
...
public interface ControllerCallInputVariableUsage extends EObject, Entity {
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Variable Usage</em>' containment reference isn't clear, there
     ...
     * <em>Variable Usage</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @param value
     *            the new value of the '<em>Variable Usage</em>' containment reference.
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Corresponding Controller Call</em>' reference isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     *
     * @param value
     *            the new value of the '<em>Corresponding Controller Call</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Containing Collection</b></em>' container reference. It is
     ...
     * <em>Controller Call Input Variable Usages</em>}'. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Containing Collection</em>' container reference isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
