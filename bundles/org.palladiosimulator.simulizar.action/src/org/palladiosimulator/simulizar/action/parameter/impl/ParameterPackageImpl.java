...
public class ParameterPackageImpl extends EPackageImpl implements ParameterPackage {
    ...
    public static ParameterPackage init() {
        ...
        final Object registeredParameterPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        final ParameterPackageImpl theParameterPackage = registeredParameterPackage instanceof ParameterPackageImpl
                ? (ParameterPackageImpl) registeredParameterPackage
    ...
    public EReference getControllerCallInputVariableUsage_VariableUsage() {
        return (EReference) this.controllerCallInputVariableUsageEClass.getEStructuralFeatures()
            .get(0);
    }
    ...
    public EReference getControllerCallInputVariableUsageCollection_ControllerCallInputVariableUsages() {
        return (EReference) this.controllerCallInputVariableUsageCollectionEClass.getEStructuralFeatures()
            .get(0);
    }
    ...
    public void initializePackageContents() {
        ...
        this.controllerCallInputVariableUsageEClass.getESuperTypes()
            .add(theEntityPackage.getEntity());
        this.controllerCallInputVariableUsageCollectionEClass.getESuperTypes()
            .add(theEntityPackage.getEntity());
