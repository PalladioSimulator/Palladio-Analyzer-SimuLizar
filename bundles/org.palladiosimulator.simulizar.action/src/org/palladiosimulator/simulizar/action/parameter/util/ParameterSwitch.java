...
public class ParameterSwitch<T> extends Switch<T> {
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Controller Call Input
     * Variable Usage</em>'. <!-- begin-user-doc --> This implementation returns null; returning a
     * non-null result will terminate the switch. <!-- end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Controller Call Input
     *         Variable Usage</em>'.
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Controller Call Input
     * Variable Usage Collection</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Controller Call Input
     *         Variable Usage Collection</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
