...
public class RoleImpl extends IdentifierImpl implements Role {
	...
	public RoleSet getRoleSet() {
		if (eContainerFeatureID() != InstancePackage.ROLE__ROLE_SET)
			return null;
	...
	public void setRoleSet(RoleSet newRoleSet) {
		if (newRoleSet != eInternalContainer()
				|| (eContainerFeatureID() != InstancePackage.ROLE__ROLE_SET && newRoleSet != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.ROLE__ROLE_SET, newRoleSet,
					newRoleSet));
	}
		...
		if (roleType != null && roleType.eIsProxy()) {
			...
			if (roleType != oldRoleType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InstancePackage.ROLE__ROLE_TYPE,
	...
	public void setRoleType(RoleType newRoleType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.ROLE__ROLE_TYPE, oldRoleType,
					roleType));
	}
	...
	public EObject getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InstancePackage.ROLE__VALUE, oldValue,
							value));
			}
		}
		return value;
