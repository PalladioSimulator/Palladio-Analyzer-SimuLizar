...
public class ReconfigurationruleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ReconfigurationrulePackage.RECONFIGURATION: {
			...
			case ReconfigurationrulePackage.TACTIC: {
			...
			case ReconfigurationrulePackage.STRATEGY: {
			...
			case ReconfigurationrulePackage.NAMED_ELEMENT: {
