...
public class MappingActionBarContributor extends EditingDomainActionBarContributor
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ActionsEditorPlugin.INSTANCE.getString("_UI_MappingEditor_menu"),
		...
		//
		createChildMenuManager = new MenuManager(ActionsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
