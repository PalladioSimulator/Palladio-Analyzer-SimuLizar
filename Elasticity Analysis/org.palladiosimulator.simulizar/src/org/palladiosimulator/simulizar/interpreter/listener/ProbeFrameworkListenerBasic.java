...
public class ProbeFrameworkListenerBasic extends ProbeFrameworkListener {

	private static final Logger LOGGER = Logger.getLogger(ProbeFrameworkListenerBasic.class);
	
	public ProbeFrameworkListenerBasic(IModelAccess modelAccess, SimuComModel simuComModel,
