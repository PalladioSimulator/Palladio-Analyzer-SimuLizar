...
/**
 * This is the action bar contributor for the Context model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class ContextActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
            ActionsEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                ContextActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
            ActionsEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return ContextActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (ContextActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) ContextActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ActionsEditorPlugin.INSTANCE.getString("_UI_ContextEditor_menu"),
                "org.palladiosimulator.simulizar.action.contextMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                ActionsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                ActionsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(ActionsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        this.populateManager(submenuManager, this.createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(ActionsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
