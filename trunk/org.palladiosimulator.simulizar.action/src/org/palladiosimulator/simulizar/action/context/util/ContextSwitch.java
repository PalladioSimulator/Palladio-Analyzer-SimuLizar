 ...
 * <!-- end-user-doc -->
 *
 * @see org.palladiosimulator.simulizar.action.context.ContextPackage
 * @generated
 */
public class ContextSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case ContextPackage.EXECUTION_CONTEXT: {
            final ExecutionContext executionContext = (ExecutionContext) theEObject;
            T result = this.caseExecutionContext(executionContext);
            if (result == null) {
                result = this.caseIdentifier(executionContext);
            }
            if (result == null) {
     ...
     * @generated
     */
    public T caseExecutionContext(final ExecutionContext object) {
        return null;
    }
