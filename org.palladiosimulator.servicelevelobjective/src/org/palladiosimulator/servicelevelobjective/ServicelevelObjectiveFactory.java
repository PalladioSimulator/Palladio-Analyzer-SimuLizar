...
public interface ServicelevelObjectiveFactory extends EFactory {
     ...
     * @generated
     */
    ServicelevelObjectiveFactory eINSTANCE = org.palladiosimulator.servicelevelobjective.impl.ServicelevelObjectiveFactoryImpl
            .init();
    ...
    /**
     * Returns a new object of class '<em>Service Level Objective</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Hard Threshold</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Linear Fuzzy Threshold</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
